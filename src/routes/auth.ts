...
export async function authRotes(app: FastifyInstance) {
    ...
    app.post('/autenticacao', async (request, reply) => {
        ...
        const { id, dataNascimento, matricula, nomeMae, cpf } = bodySchema.parse(request.body)
        ...
        if (cpf === "") {
            ...
            estadoId = userAluno ? userAluno.turma.escola.municipio.regional.estadoId : 0
            ...
            if (userExists) {
                ...
                siglaEstado = userAluno ? userAluno.turma.escola.municipio.regional.estado.sigla : ""
            }
            ...
            if (userExists) {
                ...
                siglaEstado = userProfessor? userProfessor.municipio.regional.estado.sigla : ""
            }
